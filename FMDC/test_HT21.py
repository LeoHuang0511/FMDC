...
parser.add_argument(
    '--model_path', type=str,
    default='./exp/HT21/04-20_14-22_HT21_VGG16_FPN_5e-05/ep_2_iter_6000_mae_14.908_mse_15.871_seq_MAE_7.139_WRAE_8.205_MIAE_1.398_MOAE_3.560.pth',
        ...
        for vi, data in enumerate(gen_tqdm, 0):
            ...
            with torch.no_grad():
                ...
                if frame_signal == 'match' or not opt.skip_flag:
                    ...
                    pred_map, _, pre_outflow, pre_inflow = net.test_or_validate(img, img_rgb,None)
                ...
                if frame_signal == 'match':
                    ...
                    print(' den_pre:  %.2f pre_crowd_flow: %.2f pre_inflow:%.2f'
                          %  (pred_cnt, pre_crowdflow_cnt, pre_inflow))
